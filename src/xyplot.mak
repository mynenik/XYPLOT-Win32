...
DEFINES		= -D_DEBUG=1 -D_X86_=1 -D_MT=1 -D_MBCS=1 -D_WIN32_=1 -D__NO_FPSTACK__=1
!ELSE
OUTPUTDIR	= .
CREATEOUTPUTDIR	=
TARGETDIR	= .
...
DEFINES		= -D_X86_=1 -D_MT=1 -D_MBCS=1 -D_WIN32_=1 -D__NO_FPSTACK__=1 -DDIR_ENV_VAR=\"XYPLOT_DIR\" -DVERSION=\"2.0.0\"
!ENDIF
